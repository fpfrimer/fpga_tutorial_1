...
Para inserir os \textbf{blocos dos somadores completos}, selecione a ferramenta \textbf{Symbol tool} (\raisebox{-0.25\height}{\includegraphics[height=12pt]{figs/symb.png}}), procedendo da mesma forma empregada na elaboração do esquemático do somador completo. A ação subsequente desencadeará a exibição da janela de seleção de dispositivos, conforme ilustrado na Figura~\ref{fig:symbolSomador}.
